const findBooksByPubYear = (query, pubYear) => {
    return new Promise((resolve, reject) => {
        query("SELECT id_genre, b.id_book, title, year_of_publication, keywords, cover, brief_annotation, \n" +
...
module.exports = findBooksByPubYear;
